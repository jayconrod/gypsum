...
class AstVariableDefinition(AstDefinition):
    ...
    def children(self):
        return [self.pattern, self.expression]


class AstFunctionDefinition(AstDefinition):
    def __init__(self, name, typeParameters, parameters, returnType, body):
        self.name = name
    ...
    def children(self):
        return self.typeParameters + self.parameters + [self.returnType, self.body]
...
class AstClassDefinition(AstDefinition):
    def __init__(self, name, typeParameters, constructor, supertypes, members):
        self.name = name
        self.typeParameters = typeParameters
    ...
    def children(self):
        children = self.typeParameters + self.supertypes
