...
int main(int argc, char* argv[]) {
  try {
    ...
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "f",
            reinterpret_cast<void(*)()>(registered_f)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "integerParams",
            reinterpret_cast<void(*)()>(integerParamsFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "floatParams",
            reinterpret_cast<void(*)()>(floatParamsFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "stringParams",
            reinterpret_cast<void(*)()>(stringParamsFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "nullObject",
            reinterpret_cast<void(*)()>(nullObjectFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "manyParameters",
            reinterpret_cast<void(*)()>(manyParametersFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "recursiveNative",
            reinterpret_cast<void(*)()>(recursiveNativeFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "throwNativeFunction",
            reinterpret_cast<void(*)()>(throwNativeFunction)));
    vmOptions.nativeFunctions.push_back(
        make_tuple("test.NativeCalls.registered", "throwNativeFunctionLazy",
    ...
    auto sharedlibName = Name::fromStringForPackage(String(&vm, "test.NativeCalls.sharedlib"));
    auto sharedlib = vm.loadPackage(sharedlibName,
    ...
    auto staticlibName = Name::fromStringForPackage(String(&vm, "test.NativeCalls.staticlib"));
    auto staticlib = vm.loadPackage(staticlibName,
    ...
    auto registeredName = Name::fromStringForPackage(String(&vm, "test.NativeCalls.registered"));
    auto registered = vm.loadPackage(registeredName,
